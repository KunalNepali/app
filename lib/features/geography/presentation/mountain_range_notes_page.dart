...
class MountainRangeGIPage extends StatefulWidget {
  const MountainRangeGIPage({super.key});

  @override
  State<MountainRangeGIPage> createState() => _MountainRangeGIPage();
}

class _MountainRangeGIPage extends State<MountainRangeGIPage> {
  ...
  Future<void> loadData() async {
    final String response = await rootBundle.loadString(
      'assets/data/mountain_range_gi_questions.json',
    );
