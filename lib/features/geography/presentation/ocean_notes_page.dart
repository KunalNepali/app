...
class OceanGIPage extends StatefulWidget {
  const OceanGIPage({super.key});

  @override
  State<OceanGIPage> createState() => _OceanGIPage();
}

class _OceanGIPage extends State<OceanGIPage> {
  ...
  Future<void> loadData() async {
    final String response = await rootBundle.loadString(
      'assets/data/ocean_gi_questions.json',
    );
