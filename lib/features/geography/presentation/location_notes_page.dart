...
class LocationGIPage extends StatefulWidget {
  const LocationGIPage({super.key});

  @override
  State<LocationGIPage> createState() => _LocationGIPage();
}

class _LocationGIPage extends State<LocationGIPage> {
  ...
  Future<void> loadData() async {
    final String response = await rootBundle.loadString(
      'assets/data/location_gi_questions.json',
    );
