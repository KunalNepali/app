...
class LakePondGIPage extends StatefulWidget {
  const LakePondGIPage({super.key});

  @override
  State<LakePondGIPage> createState() => _LakePondGIPage();
}

class _LakePondGIPage extends State<LakePondGIPage> {
  ...
  Future<void> loadData() async {
    final String response = await rootBundle.loadString(
      'assets/data/lake_pond_gi_questions.json',
    );
