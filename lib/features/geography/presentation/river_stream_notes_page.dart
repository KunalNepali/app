...
class RiverStreamGIPage extends StatefulWidget {
  const RiverStreamGIPage({super.key});

  @override
  State<RiverStreamGIPage> createState() => _RiverStreamGIPage();
}

class _RiverStreamGIPage extends State<RiverStreamGIPage> {
  ...
  Future<void> loadData() async {
    final String response = await rootBundle.loadString(
      'assets/data/river_stream_gi_questions.json',
    );
