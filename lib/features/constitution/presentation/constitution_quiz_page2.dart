...
class ConstitutionQuiz2Page extends StatefulWidget {
  const ConstitutionQuiz2Page({super.key});

  @override
  State<ConstitutionQuiz2Page> createState() => _ConstitutionQuiz2PageState();
}

class _ConstitutionQuiz2PageState extends State<ConstitutionQuiz2Page> {
  List questions = [];
  int currentIndex = 0;
  int? selectedIndex;
  bool answered = false;
