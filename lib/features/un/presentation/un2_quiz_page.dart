...
class UN2QuizPage extends StatefulWidget {
  const UN2QuizPage({super.key});

  @override
  State<UN2QuizPage> createState() => _UN2QuizPageState();
}

class _UN2QuizPageState extends State<UN2QuizPage> {
  List questions = [];
  int currentIndex = 0;
  int? selectedIndex;
  bool answered = false;
