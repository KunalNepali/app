...
class Development2QuizPage extends StatefulWidget {
  const Development2QuizPage({super.key});

  @override
  State<Development2QuizPage> createState() => _Development2QuizPageState();
}

class _Development2QuizPageState extends State<Development2QuizPage> {
  List questions = [];
  int currentIndex = 0;
  int? selectedIndex;
  bool answered = false;
